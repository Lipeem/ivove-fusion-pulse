  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/lovable-uploads/0dbee74c-e196-44ba-bb42-49d4136303d4.png')",
      ...
      <div className="absolute inset-0 opacity-40">
        <div
          className="absolute top-1/4 left-1/6 w-1 h-1 bg-white rounded-full animate-twinkle"
          style={{ animationDelay: "0s" }}
        />
        <div
          className="absolute top-1/3 right-1/4 w-0.5 h-0.5 bg-white rounded-full animate-twinkle"
        ...
        />
        <div
          className="absolute top-3/4 right-1/5 w-0.5 h-0.5 bg-white rounded-full animate-twinkle"
          style={{ animationDelay: "6s" }}
        />
        <div
          className="absolute top-1/5 left-3/4 w-1 h-1 bg-white rounded-full animate-twinkle"
          style={{ animationDelay: "8s" }}
        />
        <div
          className="absolute bottom-1/3 right-2/3 w-0.5 h-0.5 bg-white rounded-full animate-twinkle"
          style={{ animationDelay: "10s" }}
        />
        <div
          className="absolute top-2/3 left-1/8 w-1 h-1 bg-white rounded-full animate-twinkle"
          style={{ animationDelay: "12s" }}
        />
        <div
          className="absolute bottom-1/5 right-1/8 w-0.5 h-0.5 bg-white rounded-full animate-twinkle"
      ...
      <div
        className="absolute top-1/4 left-1/4 animate-orbit-slow opacity-75"
        style={{ animationDelay: "0s" }}
      >
      ...
      {/* PLANETA SATURNO com Anéis e Luas */}
      <div
        className="absolute top-1/3 right-1/4 animate-orbit-slow opacity-80"
        style={{ animationDelay: "10s" }}
      >
        <div className="relative w-24 h-24">
          {/* Saturno - Planeta gasoso dourado */}
          <div className="absolute inset-0 bg-gradient-to-b from-yellow-200/80 via-yellow-400/80 via-yellow-600/80 to-yellow-800/80 rounded-full shadow-2xl"></div>
          {/* Sutis faixas de Saturno */}
          <div className="absolute top-16 left-1 right-1 h-1 bg-yellow-100/40 rounded-full"></div>
          <div className="absolute top-8 left-2 right-2 h-0.5 bg-yellow-300/30 rounded-full"></div>
          <div className="absolute top-12 left-1 right-1 h-1 bg-yellow-500/30 rounded-full"></div>
          <div className="absolute top-16 left-2 right-2 h-0.5 bg-yellow-700/30 rounded-full"></div>

          {/* Anéis de Saturno - múltiplos anéis concêntricos */}
          <div className="absolute -inset-6 w-36 h-36 border-2 border-yellow-300/50 rounded-full transform rotate-12"></div>
          <div className="absolute -inset-4 w-32 h-32 border border-yellow-400/40 rounded-full transform rotate-12"></div>
          <div className="absolute -inset-2 w-28 h-28 border border-yellow-200/35 rounded-full transform rotate-12"></div>
          <div className="absolute -inset-8 w-40 h-40 border border-yellow-100/25 rounded-full transform rotate-12"></div>
          {/* Divisão de Cassini (espaço entre anéis) */}
          <div className="absolute -inset-5 w-34 h-34 border border-transparent rounded-full transform rotate-12"></div>

          {/* Lua Titã (maior lua) */}
          <div className="absolute -top-8 -right-12 w-5 h-5 bg-gradient-to-br from-orange-200/70 to-orange-500/70 rounded-full animate-orbit-medium shadow-lg">
            <div className="absolute inset-0.5 bg-gradient-to-br from-orange-300/50 to-orange-600/50 rounded-full"></div>
            {/* Atmosfera de Titã */}
            <div className="absolute -inset-0.5 bg-gradient-to-br from-orange-100/20 via-transparent to-transparent rounded-full"></div>
          </div>

          {/* Lua Enceladus (lua gelada) */}
          <div
            className="absolute -bottom-6 -left-10 w-3 h-3 bg-gradient-to-br from-blue-100/70 to-blue-200/70 rounded-full animate-orbit-fast"
            style={{ animationDelay: "15s" }}
          >
            <div className="absolute inset-0.5 bg-gradient-to-br from-white/60 to-blue-100/40 rounded-full"></div>
          </div>
        </div>
      </div>
      ...
      <div
        className="absolute bottom-1/3 left-1/3 animate-orbit-medium opacity-75"
      ...
      >
        <div className="relative w-18 h-18">
          ...
          {/* Lua Titã */}
          <div
            className="absolute -top-6 right-4 w-3 h-3 bg-gradient-to-br from-orange-200/70 to-orange-400/70 rounded-full animate-orbit-fast"
      ...
      {/* PLANETA MARTE */}
      <div
        className="absolute bottom-1/4 right-1/3 animate-orbit-fast opacity-70"
      ...
      >
        <div className="relative w-14 h-14">
          ...
          {/* Lua Fobos */}
          <div
            className="absolute -top-3 -right-6 w-2 h-2 bg-gradient-to-br from-gray-400/70 to-gray-600/70 rounded-full animate-orbit-fast"
      ...
      <div
        className="absolute top-3/5 left-1/5 animate-orbit-medium opacity-65"
      ...
      <div
        className="absolute top-1/2 right-1/5 animate-orbit-slow opacity-60"
      ...
      <div className="absolute bottom-1/6 left-1/6 w-14 h-14 opacity-35">
        <div
          className="absolute inset-0 bg-gradient-radial from-cyan-400/18 via-blue-500/12 to-transparent rounded-full animate-pulse-slow"
          style={{ animationDelay: "20s" }}
        ></div>
      ...
      {/* ESTAÇÃO ESPACIAL */}
      <div
        className="absolute top-2/5 left-3/5 animate-orbit-fast opacity-70"
      ...
      <div
        className="absolute top-4/5 right-2/5 animate-orbit-slow opacity-55"
      ...
      <div
        className="absolute bottom-2/5 left-2/5 animate-orbit-fast opacity-50"
